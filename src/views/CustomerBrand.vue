<template>
    <div>
        <div class="header">
            <h2 >全部品牌</h2>
            <el-button type="primary" round @click="addDialogVisibles = true"  > 新增</el-button>
        </div>
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                   <div class="column-but">
                    ...
                    size="mini"
                    type="info"
                     @click="updateBrand(scope.row)">编辑</el-button>
                    <el-button
                    size="mini"
                    type="danger"
                    @click="delBrand(scope.row)">删除</el-button>
                   </div>
                </template>
            </el-table-column>
        ...
        <el-dialog
          ...
          <span slot="footer" class="addDialogVisibles-footer">
            <el-button @click="addDialogVisibles = false" class="addbtn">取 消</el-button>
            <el-button type="primary" @click="addBrand" class="addbtn">确 定</el-button>
          </span>
        </el-dialog>
        <el-dialog
          title="修改品牌"
          ...
          width="40%"
          center>
          <el-input v-model="updateinput" placeholder="请输入修改品牌名称" ></el-input>
          <span slot="footer" class="addDialogVisibles-footer">
